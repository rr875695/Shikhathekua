...
const products = {
  1: {
    ...
    price: 150,
    description:
      "Traditional Bihar Thekua made with pure sugar, wheat flour, and ghee. Perfect for festivals and special occasions.",
  ...
  2: {
    ...
    price: 180,
    description:
      "Modern twist on traditional Thekua with flavors like rose, kesar, and vanilla.",
    ingredients: [
      "Wheat Flour",
      "Sugar",
      "Ghee",
  ...
  3: {
    ...
    price: 200,
    description:
      "Thekua enriched with natural fruit essences like mango, strawberry, and orange.",
  ...
  4: {
    ...
    price: 250,
    description:
      "Premium Thekua loaded with dry fruits like almonds, cashews, and raisins.",
    ingredients: [
      "Wheat Flour",
      "Sugar",
      "Ghee",
...
// ✅ Page Component (loose typing to fix build error)
